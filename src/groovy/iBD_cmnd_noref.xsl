 ...
 * @author DM Smith [dmsmith555 at yahoo dot com]
 ...
 <xsl:stylesheet
  ...
  <xsl:param name="BCVNum" select="'true'"/>
  ...
  <xsl:template name="lemma">
    ...
    <xsl:choose>
      <xsl:when test="$separator = ''">
        ...
        <sub class="strongs"><a href="{$protocol}//{$orig-lemma}" onclick='return doProtocol(&quot;{$protocol}&quot;,&quot;{$orig-lemma}&quot;);'><xsl:value-of select="format-number(substring($orig-lemma,2),'#')"/></a></sub>
      </xsl:when>
      <xsl:otherwise>
        ...
        <sub class="strongs"><a href="{$protocol}//{substring-before($orig-lemma, $separator)}"  onclick='return doProtocol(&quot;{$protocol}&quot;,&quot;{substring-before($orig-lemma, $separator)}&quot;);'><xsl:value-of select="format-number(substring(substring-before($orig-lemma, $separator),2),'#')"/></a>, </sub>
        <xsl:call-template name="lemma">
