 ...
 * @author DM Smith [dmsmith555 at yahoo dot com]
 ...
 <xsl:stylesheet
  ...
  <xsl:template name="versenum">
    ...
    <xsl:if test="$NoVNum = 'false'">
      ...
      <xsl:choose>
		...
		<a href="bible://{@osisID}" name="{@osisID}" onclick='return handlePassage(&quot;{@osisID}&quot;);' class='strongs'><sup class="verse"><xsl:value-of select="$versenum"/></sup>  </a>
        </xsl:when>
  ...
  <xsl:template name="lemma">
	...
	<span class="strongs"><a href="{$protocol}//{$orig-lemma}" class='strongs' ><xsl:value-of select="format-number(substring($orig-lemma,2),'#')"/></a></span>
      </xsl:when>
      <xsl:otherwise>
        ...
        <span class="strongs"><a href="{$protocol}//{substring-before($orig-lemma, $separator)}" class='strongs' ><xsl:value-of select="format-number(substring(substring-before($orig-lemma, $separator),2),'#')"/></a>, </span>
        <xsl:call-template name="lemma">
  ...
  <xsl:template name="morph">
    ...
    <xsl:choose>
      <xsl:when test="$separator = ''">
        ...
        <sub class="morph"><a href="{$protocol}//{$orig-morph}"  onclick='return doProtocol(&quot;{$protocol}&quot;,&quot;{$orig-morph}&quot;);'><xsl:value-of select="$orig-morph"/></a></sub>
      </xsl:when>
      <xsl:otherwise>
        ...
        <sub class="morph"><a href="{$protocol}//{substring-before($orig-morph, $separator)}"  onclick='return doProtocol(&quot;{$protocol}&quot;,&quot;{substring-before($orig-morph, $separator)}&quot;);'><xsl:value-of select="substring-before($orig-morph, $separator)"/></a>, </sub>
        <xsl:call-template name="morph">
